          ...
          <div className="bg-secondaryColor relative">
               <div className="flex  lg:flex-row md:flex-col flex-col lg:gap-32 md:gap-20 gap-16 py-24 lg:max-w-[1200px] md:max-w-[700px] max-w-[360px] justify-between  px-0 mx-auto">
                    <div className="lg:w-1/2 md:w-full w-full space-y-10">
                         ...
                         <p className="text-base text-center lg:text-start font-normal text-white">Real Estate (Pvt.) Ltd., established in 1988, is one of the pioneers in the Real Estate and Housing Industry of Bangladesh and one of the founding members of the Real Estate & Housing Association of Bangladesh (REHAB). During its 36 years journey, Sheltech has constructed over 4110 apartments (Residential & Commercial) all around Dhaka city and has become a household name for real estate.
                              <br />
                              All Real Estate buildings are designed according to the guidelines stated in the Bangladesh National Building Code (BNBC). As such, Real Estate was the first developer to be awarded the ISO 9001:2015 certificate, in recognition of our quality construction and management practices in the real estate development sector.

                              At Real Estate, we believe that our most important achievement to date has been earning the trust and confidence of our clients and patrons. We would like to take this opportunity to thank you for giving us the opportunity to build the home of your dreams.</p>
                    </div>
