...
const EditBlog = () => {
     ...
     // Blog edit id
     const blogEditId = useParams();
     console.log(blogEditId);

     // react from hook for from handling
     const { register,
          handleSubmit,
          setValue,
     ...
     return (
          <div className="2xl:max-w-screen-2xl xl:max-w-screen-lg lg:max-w-screen-md md:max-w-screen-sm max-w-[360px] mx-auto py-4">
               <h1 className="text-xl font-medium  text-center"> Blog Edit Section Information</h1>
