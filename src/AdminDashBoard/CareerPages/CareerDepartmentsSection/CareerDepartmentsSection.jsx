...
const CareerDepartmentsSection = () => {
     const { handleSubmit,
          register,
     ...
     return (
          <div className="2xl:max-w-screen-2xl xl:max-w-screen-lg lg:max-w-screen-md md:max-w-screen-sm max-w-[360px] mx-auto py-4">
               <h1 className="text-xl font-medium  text-center">Career Department  Section Information</h1>
               <div className="bg-white border border-slate-200 rounded-lg shadow-lg">
                    <form onSubmit={handleSubmit(onSubmit)} className="pb-10 pt-6 space-y-6">
                         ...
                         <div className="flex items-center justify-center">
                              ...
                              <div className="lg:w-3/5 w-full">
                                   <select className="lg:w-3/5 w-full border text-base font-medium">

                                        <option defaultChecked>Select One Icon</option>
                                        <option value="BiBriefcase"><BiBriefcase /></option>
                                        <option value="">dnsfvu9sd</option>
                                        <option value="">dnsfvu9sd</option>
                                   </select>
                              </div>
                         </div>
...
export default CareerDepartmentsSection;